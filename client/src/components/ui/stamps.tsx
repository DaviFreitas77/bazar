    ...
    <section className="flex justify-center items-center px-4 ">
      <div className="justify-between max-w-[1100px] 2xl:max-w-[1300px] py-15 w-full hidden lg:flex">
        <div className="flex items-center gap-2">
          <PiPixLogoLight size={44}  className="text-primary-50" />
        ...
        <div className="flex items-center gap-2">
          <CiCreditCard2 size={44}  className="text-primary-50" />
          <div className="leading-5">
        ...
        <div className="flex items-center gap-2">
          <HiOutlineCheckBadge size={44}  className="text-primary-50" />
          <div className="leading-5">
        ...
        <div className="flex items-center gap-2">
          <CiDeliveryTruck size={44}  className="text-primary-50" />
          <div className="leading-5">
        ...
        >
          <SwiperSlide>
            <div className="flex items-center gap-2 justify-center">
              ...
              <div className="leading-5">
                <p className="text-gray-800 font-semibold text-xs">PIX</p>
                <p className="mt-1 text-xs">Compre rápido</p>
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="flex items-center gap-2 justify-center">
              ...
              <div className="leading-5">
                <p className="text-gray-800 font-semibold text-xs">CARTÃO</p>
                <p className="mt-1 text-xs">em até 12x</p>
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="flex items-center gap-2 justify-center">
              ...
              <div className="leading-5">
                <p className="text-gray-800 font-semibold text-xs">SITE SEGURO</p>
                <p className="mt-1 text-xs">compre tranquilo</p>
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="flex items-center gap-2  justify-center">
              ...
              <div className="leading-5">
                <p className="text-gray-800 font-semibold text-xs">RETIRE</p>
                <p className="mt-1 text-xs">gratís no bazar</p>
              </div>
            </div>
          </SwiperSlide>
