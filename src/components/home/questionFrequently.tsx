  ...
  return(
      <section className="mt-32 flex justify-center items-center px-10">
        <div className=" max-w-[1450px] w-full flex flex-col gap-5">
          ...
          <AccordionFilter padding="12px 10px 12px 10px" backgroundColor="#F9F9F9" name="Os produtos no site são novos?">
          ...
          <AccordionFilter padding="12px 10px 12px 10px" backgroundColor="#F9F9F9" name="Quais são as formas de pagamento?">
          ...
          <AccordionFilter padding="12px 10px 12px 10px" backgroundColor="#F9F9F9" name="Vocês fazem entrega?">
            <p className="pl-2">No momento não fazemos entrega,você poderá retirar seu pedido em R. exemplo,bairro-SP</p>
          </AccordionFilter>
          <AccordionFilter padding="12px 10px 12px 10px" backgroundColor="#F9F9F9" name="O bazar tem um local para que eu possa visitar?">
